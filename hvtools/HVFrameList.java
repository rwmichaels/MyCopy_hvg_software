 ...
 * Mod&Add: 27-Feb-2002 add methods getToken() and regionMatches()
 * Mod&Add: 24-Apr-2014 add property 'server.port' to change default ServerPort=5555
                        add methods getServerPort(), setServerPort(port)
			add constructor HVFrameList(String infile)
 */
public class HVFrameList extends Parameters {
    ...
    public String defaultServerPort = "5555"; //* 24-Apr-2014
    ...
    private int serverPort = 5555;//* 24-Apr-2014
    private String key_serverPort = "server.port"; //* 24-Apr-2014
    ...
    /**
     * Constructor init and load parameters from file
     * @param infile String file name
     */
    public HVFrameList(String infile) {
	super(infile, "HVFrame Hosts List");	
      loadstatus = getParameters();
    }
	...
	defaults.put(key_serverPort, defaultServerPort); //* 24-Apr-2014
    }
    ...
    protected void updateSettingsFromProperties() {
	    ...
	    tmp = properties.getProperty(key_serverPort);
	    serverPort= Integer.parseInt(tmp);//* 24-Apr-2014
	...
	properties.put(key_serverPort, 
		       new Integer(serverPort).toString()); //* 24-Apr-2014	
    }
    
   /**
     * Returns server port from property  'serverPort'
     * @return int server port
     */
     public  int getServerPort() { //* 24-Apr-2014
	return serverPort;
    }

    /**
     * Sets server port to the property 'serverPort'
     * @param port int server port
     */
    public void setServerPort(int port) { //* 24-Apr-2014
   ...
   /**
     * Returns number of mainframe hosts from property variable nFrames
